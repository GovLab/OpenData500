...
states ={ 
            ...
            "au": {"ACT":"Australian Capital Territory", "JBT":"Jervis Bay Territory", "NSW":"New South Wales", "NT":"Northern Territory", "QLD":"Queensland", "SA":"South Australia", "TAS":"Tasmania", "VIC":"Victoria", "WA":"Western Australia"}
        }
stateListAbbrev = { 
            ...
            "au": ["", "ACT", "JBT", "NSW", "NT", "QLD", "SA", "TAS", "VIC", "WA"],
...
stateList = {
            ...
            "au": ["(Select Province/Territory)", "Australian Capital Territory", "Jervis Bay Territory", "New South Wales", "Northern Territory", "Queensland", "South Australia", "Tasmania", "Victoria", "Western Australia"],
            "mx": ["(Seleccione un Estado)", "Aguascalientes", "Baja California", "Baja California Sur", "Campeche", "Chiapas", "Chihuahua", "Coahuila", "Colima", "Distrito Federal", "Durango", "Estado de México", "Guanajuato", "Guerrero", "Hidalgo", "Jalisco", "Michoacán", "Morelos", "Nayarit", "Nuevo León", "Oaxaca", "Puebla", "Querétaro", "Quintana Roo", "San Luis Potosí", "Sinaloa", "Sonora", "Tabasco", "Tamaulipas", "Tlaxcala", "Veracruz", "Yucatán", "Zacatecas"]
            }
agency_types = ['Federal','State','City/County','University/Institution']
available_countries = ["us", "au", "mx"]
country_keys = { "us":"United States", "au":"Australia", "United States":"us", "Australia":"au",  "Mexico":"mx", "mx":"Mexico"}
